...
const [getConfig1, setConfigMatcher] = mod4.getConfigAndMatcher({
    "peer-tor-address": {
    ...
    color: {
        ...
        nullable: false,
        pattern: "[0-9a-fA-F]{6}",
        "pattern-description": "Must be a valid 6 digit hexadecimal RGB value. The first two digits are red, the middle two are green, and the final two are blue.",
        default: {
            charset: "a-f,0-9",
            len: 6
        }
    ...
    "watchtowers": {
        ...
        spec: {
            "wt-server": {
                ...
                description: "Allow other nodes to connect to your watchtower server on the network.  <b>Default: Disabled</b>",
                nullable: true,
                default: false
            },
            "wt-client": {
                ...
                variants: {
                    ...
                    enabled: {
                        "add-watchtowers": {
                            ...
                            description: "Add URIs of watchtower servers to connect to. If you don't know of anyone with a server, you can find some on this public listing: https://github.com/talaia-labs/rust-teos/discussions/158",
                            range: "[1,*)",
                            subtype: "string",
                            spec: {
                                masked: false,
                                copyable: true,
                                placeholder: "02b4891f562c8b80571ddd2eeea48530471c30766295e1c78556ae4c4422d24436@recnedb7xfhzjdrcgxongzli3a6qyrv5jwgowoho3v5g3rwk7kkglrid.onion:9814"
                            },
                            default: Array()
                        }
                    }
    ...
    autoclean: {
        ...
        spec: {
            ...
            "autoclean-succeededforwards-age": {
                ...
                description: "How old successful forwards (settled in listforwards status) have to be before deletion. <b>Default: 0, meaning never.</b>",
                nullable: true,
                range: "[0,*)",
                integral: true,
                default: 0,
            ...
            "autoclean-failedforwards-age": {
                ...
                description: "How old failed forwards (failed or local_failed in listforwards status) have to be before deletion.  <b>Default: 0, meaning never.</b>",
                nullable: true,
                range: "[0,*)",
                integral: true,
                default: 0,
            ...
            "autoclean-succeededpays-age": {
                ...
                description: "How old successful payments (complete in listpays status) have to be before deletion.  <b>Default: 0, meaning never.</b>",
                nullable: true,
                range: "[0,*)",
                integral: true,
                default: 0,
            ...
            "autoclean-failedpays-age": {
                ...
                description: "How old failed payment attempts (failed in listpays status) have to be before deletion.  <b>Default: 0, meaning never.</b>",
                nullable: true,
                range: "[0,*)",
                integral: true,
                default: 0,
            ...
            "autoclean-paidinvoices-age": {
                ...
                description: "How old invoices which were paid (paid in listinvoices status) have to be before deletion.  <b>Default: 0, meaning never.</b>",
                nullable: true,
                range: "[0,*)",
                integral: true,
                default: 0,
            ...
            "autoclean-expiredinvoices-age": {
                ...
                description: "How old invoices which were not paid (and cannot be) (expired in listinvoices status) before deletion.  <b>Default: 0, meaning never</b>",
                nullable: true,
                range: "[0,*)",
                integral: true,
                default: 0,
    ...
    advanced: {
        ...
        spec: {
            ...
            "fee-base": {
                ...
                description: "The base fee in millisatoshis you will charge for forwarding payments on your channels.  <b>Default: 1000</b>",
                nullable: false,
                range: "[0,*)",
                integral: true,
                default: 1000,
            ...
            "fee-rate": {
                ...
                description: "The fee rate used when forwarding payments on your channels. The total fee charged is the Base Fee + (amount * Fee Rate / 1,000,000), where the amount is the forwarded amount.  Measured in sats per million.  <b>Default: 1</b>",
                nullable: false,
                range: "[1,1000000)",
                integral: true,
                default: 1,
            ...
            "ignore-fee-limits": {
                ...
                description: "Allow nodes which establish channels to you to set any fee they want. This may result in a channel which cannot be closed, should fees increase, but make channels far more reliable since Core Lightning will never close it due to unreasonable fees.  <b>Default: False</b>",
                default: false
            },
            "funding-confirms": {
                type: "number",
                name: "Required Funding Confirmations",
                description: "Confirmations required for the funding transaction when the other side opens a channel before the channel is usable.  <b>Default: 3</b>",
                nullable: false,
                range: "[1,6]",
                integral: true,
                default: 3,
            ...
            "cltv-delta": {
                ...
                description: "The number of blocks between the incoming payments and outgoing payments: this needs to be enough to make sure that if it has to, Core Lightning can close the outgoing payment before the incoming, or redeem the incoming once the outgoing is redeemed.  <b>Default: 40</b>",
                nullable: false,
                range: "[6,144]",
                integral: true,
                default: 40,
            ...
            "htlc-minimum-msat": {
                ...
                description: "Sets the minimal allowed HTLC value for newly created channels. If you want to change the htlc_minimum_msat for existing channels, use the RPC call lightning-setchannel.  <b>Default: unset (no minimum)</b>",
                nullable: true,
                range: "[0,*)",
                integral: true,
                units: "millisatoshis"
            ...
            "htlc-maximum-msat": {
                ...
                description: "Sets the maximum allowed HTLC value for newly created channels. If you want to change the htlc_maximum_msat for existing channels, use the RPC call lightning-setchannel.  <b>Default: unset (no limit)</b>",
                nullable: true,
                range: "[0,*)",
                integral: true,
                units: "millisatoshis"
                            ...
                            enabled: {
                                strategy: {
                                    ...
                                    tag: {
                                        id: "mode",
                                        name: "Operating Mode",
                                        description: "Select from two different operating strategies: Incognito, or Liquidity Merchant, and fine-tune your selected strategy's settings.<br><ul><li><b>Incognito: </b>Wait for others to stumble upon your unadvertised node and open a dual-fund request, then react in a more complex way</li><li><b>Liquidity Merchant: </b>Advertise and sell liquidity on the market in a straightforward way (i.e., always match 100% of requested funds, and don't accept dual-funding requests that aren't channel lease requests).</li></ul><br><b>Default: Incognito</b>",
                                        "variant-names": {
                                            incognito: "Incognito",
                                    ...
                                    variants: {
                                        incognito: {
                                            policy: {
                                                ...
                                                tag: {
                                                    id: "policy",
                                                    name: "Policy Type",
                                                    description: "<ul><li><b>Match: </b>Contribute a percentage of their requested funds.</li><li><b>Available: </b>Contribute policy_mod percent of our available node wallet funds.</li><li><b>Fixed: </b>Contribute a fixed number of sats to v2 channel open requests.</li></ul><br><b>Default: Match</b>",
                                                    "variant-names": {
                                                        match: "Match",
                                                        available: "Available",
                                                        fixed: "Fixed"
                                                ...
                                                description: "Determines how your node will react to a dual-funding channel open request",
                                                default: "match",
                                                variants: {
                                                    match: {
                                                        "policy-mod": {
                                                            ...
                                                            description: "Percentage of requested funds to commit to the channel. If this is a channel lease request, we match based on their requested funds. If it is not a channel lease request (and leases only is false, which is is by default), then we match their funding amount. Note: any lease match less than 100 will likely fail, as clients will not accept a lease less than their request.  <b>Default: 100</b>",
                                                            range: "[0,200]",
                                                            integral: true,
                                                            units: "percent",
                                                            default: 100
                                                    ...
                                                    available: {
                                                        "policy-mod": {
                                                            ...
                                                            description: "Percentage of available on-chain funds to commit to the channel.  <b>Default: 100</b>",
                                                            range: "[0,100]",
                                                            integral: true,
                                                            units: "percent",
                                                            default: 100
                                                    ...
                                                    fixed: {
                                                        "policy-mod": {
                                                            ...
                                                            description: "Fixed number of sats to contribute to the channel.  <b>Default: 10000</b>",
                                                            range: "[0,10000000000)",
                                                            integral: true,
                                                            units: "satoshis",
                                                            default: 10000
                                            ...
                                            "fuzz-percent": {
                                                ...
                                                description: "A percentage to fuzz the resulting contribution amount by.<b>WARNING: Fuzzing with a Match 100% policy can cause random failures.<b><br><b>Defaults to 0% (no fuzz)</b>",
                                                range: "[0,100]",
                                                integral: true,
                                                units: "percent"
                                            },
                                            "fund-probability": {
                                                ...
                                                description: "The percent of v2 channel open requests to apply our policy to. Valid values are integers from 0 (fund no requests) to 100 (fund every request). Useful for randomizing opens that receive funds.  <b>Default: 100</b>",
                                                range: "[0,100]",
                                                integral: true,
                                                units: "percent",
                                                default: 100
                                        ...
                                        merchant: {
                                            "lease-fee-base-sat": {
                                                ...
                                                description: "The flat fee for a channel lease. Node will receive this much extra added to their channel balance, paid by the opening node.  <b>Default: 2000</b>",
                                                range: "[1,10000000000)",
                                                integral: true,
                                                units: "satoshis",
                                                default: 2000
                                            ...
                                            "lease-fee-basis": {
                                                ...
                                                description: "A basis fee that's calculated as 1/10k of the total requested funds the peer is asking for. Node will receive the total of the lease fee basis * requested funds / 10k satoshis added to their channel balance, paid by the opening node. <b>Default: 0.65% (65 basis points)</b>",
                                                range: "[0,1000000)",
                                                integral: true,
                                            ...
                                            "funding-weight": {
                                                ...
                                                nullable: true,
                                                name: "Funding Weight",
                                                description: "Transaction weight the channel opener will pay us for a leased funding transaction. Node will have this funding fee added to their channel balance, paid by the opening node. <b>Default: dynamically calculated for 2 inputs + 1 P2WPKH output</b>",
                                                range: "[0,10000]",
                                                integral: true,
                                                units: "weight units"
                                            },
                                            "channel-fee-max-base-msat": {
                                                ...
                                                description: "A commitment to a maximum channel_fee_base_msat that your node will charge for routing payments over this leased channel during the lease duration. <b>Default: 5000000</b>",
                                            ...
                                            "channel-fee-max-proportional-thousandths": {
                                                ...
                                                description: "A commitment to a maximum channel_fee_proportional_millionths that your node will charge for routing payments over this leased channel during the lease duration. Note that it's denominated in 'thousandths'. A setting of 1 is equal to 1k ppm; 5 is 5k ppm, etc. <b>Default: 100 (100k ppm)</b>",
                                                range: "[0,1000]",
                                                integral: true,
                                                units: "thousandths",
                                                default: 100
                                ...
                                other: {
                                    type: "object",
                                    name: "Other Settings",
                                    description: "Additional settings that apply to both operating strategies",
                                    spec: {
                                        "min-their-funding-msat": {
                                            type: "number",
                                            nullable: true,
                                            name: "Minimum Their Funding",
                                            description: "The minimum funding msats that we require in order to activate our contribution policy to the v2 open.  <b>Default: 10000000</b>",
                                            range: "[0,10000000000000)",
                                            integral: true,
                                            units: "millisatoshis",
                                            default: 10000000
                                        ...
                                        "max-their-funding-msat": {
                                            ...
                                            description: "The maximum funding msats that we will consider to activate our contribution policy to the v2 open. Any channel open above this will not be funded.  <b>Default: No max</b>",
                                            range: "[0,10000000000000)",
                                            integral: true,
                                            units: "millisatoshis"
                                        },
                                        "per-channel-min-msat": {
                                            ...
                                            description: "The minimum amount that we will contribute to a channel open.  <b>Default: 10000000",
                                            range: "[0,10000000000000)",
                                            integral: true,
                                            units: "millisatoshis",
                                            default: 10000000
                                        ...
                                        "per-channel-max-msat": {
                                            ...
                                            description: "The maximum amount that we will contribute to a channel open.  <b>Default: 10000000</b>",
                                            range: "[0,10000000000000)",
                                            integral: true,
                                            units: "millisatoshis",
                                            default: 10000000
                                        ...
                                        "reserve-tank-msat": {
                                            ...
                                            nullable: true,
                                            name: "Reserve Tank",
                                            description: "The amount of msats to leave available in the node wallet.  <b>Default: Nothing (can use all on-chain funds)</b>",
                                            range: "[0,10000000000000)",
                                            integral: true,
                                            units: "millisatoshis"
                                        }
            ...
            plugins: {
                ...
                spec: {
                    sling: {
                        type: "boolean",
                        name: "Sling",
                        description: "Automatically rebalance multiple channels. This is a CLI-only tool.  <b>Default: Disabled</b><br><b>Source:  https://github.com/daywalker90/sling</b>",
                        default: false,
                        required: false,
                        nullable: true
                    },
                    clnrest: {
                        type: "boolean",
                        name: "CLNRest",
                        description: "Distinct from the C-Lightning-REST plugin, CLNRest is a lightweight Python-based built-in Core Lightning plugin (from v23.08) that transforms RPC calls into a REST service. It also broadcasts Core Lightning notifications to listeners connected to its websocket server. By generating REST API endpoints, it enables the execution of Core Lightning's RPC methods behind the scenes and provides responses in JSON format.  <b>Default: True</b>",
                        default: true
                    },
                    clboss: {
                        type: "union",
                        ...
                        tag: {
                            ...
                            description: "CLBOSS is an automated manager for Core Lightning forwarding nodes.  <b>Default: Disabled</b><br><b>Source: https://github.com/ZmnSCPxj/clboss</b>",
                            "variant-names": {
                                disabled: "Disabled",
                                enabled: "Enabled"
                            }
                        ...
                        variants: {
                            ...
                            enabled: {
                                "min-onchain": {
                                    ...
                                    description: "The minimum amount that CLBOSS will leave in the on-chain wallet. The intent is that this amount will be used in the future, by your node, to manage anchor-commitment channels, or post-Taproot Decker-Russell-Osuntokun channels. These channel types need some small amount of on-chain funds to unilaterally close, so it is not recommended to set it to 0. The amount specified is a ballpark figure, and CLBOSS may leave slightly lower or slightly higher than this amount.  <b>Default: 30000</b>",
                                    range: "[0,10000000000)",
                                    integral: true,
                                    units: "satoshis",
                                    deafult: 30000
                                ...
                                "auto-close": {
                                    type: "boolean",
                                    name: "Auto Close",
                                    description: "Enable if you want CLBOSS to have the ability to close channels it deems unprofitable.  This can be costly, please understand the ramifications before enabling.  <b>Default: False</b>",
                                    default: false,
                                ...
                                "min-channel": {
                                    ...
                                    description: "Sets the minimum channel sizes that CLBOSS will make.  <b>Default:  No minimum</b>",
                                    range: "[0,10000000000)",
                                    integral: true,
                                    units: "satoshis"
                                },
                                "max-channel": {
                                    ...
                                    description: "Sets the maximum channel sizes that CLBOSS will make.  <b>Default:  No maximum</b>",
                                    range: "[0,10000000000)",
                                    integral: true,
                                    units: "satoshis"
                                }
...
const { string: string2, boolean: __boolean1, shape: shape1, arrayOf: arrayOf1 } = mod;
const matchWTtEnabledConfig = shape1({
    watchtowers: shape1({
        "wt-server": __boolean1,
        "wt-client": shape1({
            "enabled": string2,
            "add-watchtowers": arrayOf1(string2)
        })
    })
});
const configRules = [
            ...
            if (matchWTtEnabledConfig.test(config)) {
                for(const outerIndex in config.watchtowers["wt-client"]["add-watchtowers"]){
                    ...
                    for(const innerIndex in config.watchtowers["wt-client"]["add-watchtowers"]){
                        const innerTowerUri = config.watchtowers["wt-client"]["add-watchtowers"][innerIndex];
                        if (outerIndex != innerIndex) {
                            if (outerTowerUri.split("@")[0] == innerTowerUri.split("@")[0]) {
...
const setConfig1 = async (effects, input)=>{
    ...
    try {
        if (config.watchtowers["wt-client"].enabled == "enabled") {
            config.watchtowers["wt-client"]["add-watchtowers"].map((x)=>{
    ...
    return await mod4.setConfig(effects, config);
};
const properties1 = mod4.properties;
const migration = mod4.migrations.fromMapping({}, "0.3.5");
const health = {
    async "web-ui" (effects, duration) {
        return mod5.checkWebUrl("http://hello-world.embassy:80")(effects, duration).catch(mod5.catchError(effects));
    }
};
const { shape: shape2, string: string3 } = mod;
const matchOldBitcoindConfig = shape2({
    rpc: shape2({
        advanced: shape2({
            serialversion: mod.any
        })
    }),
    advanced: shape2({
        pruning: shape2({
...
const matchBitcoindConfig = shape2({
    advanced: shape2({
        pruning: shape2({
            mode: string3
        })
    ...
    bitcoind: {
        async check (effects, configInput) {
            ...
            if (matchOldBitcoindConfig.test(configInput) && configInput.advanced.pruning.mode !== "disabled") {
                return {
                    error: 'Pruning must be disabled to use CLN with <= 24.0.1 of Bitcoin Core. To use CLN with a pruned node, update Bitcoin Core to >= 25.0.0~2.'
                };
            }
            return {
                result: null
